...
import {ContentTypeDestroyed, ContentTypesDestroyedBulk, ContentTypeStored, ContentTypeUpdated, ContentFieldDestroyed, ContentFieldStored, ContentFieldUpdated} from 'nuclear-hierarchy-ui'


export default {
	components: { ImageUpdated, MediaDestroyedBulk, MediumDestroyed, MediumEmbedded, MediumUpdated, MediumUploaded, PermissionDestroyed, PermissionRevoked, PermissionsDestroyedBulk, PermissionStored, PermissionUpdated, ProfileUpdated, ProfileUpdatedPassword, RoleDestroyed, RoleRevoked, RolesDestroyedBulk, RoleStored, RoleUpdated, UserDestroyed, UsersDestroyedBulk, UserStored, UserUpdated, UserUpdatedPassword, TagDestroyed, TagsDestroyedBulk, TagStored, TagTranslated, TagTranslationDestroyed, TagUpdated, ContentTypeDestroyed, ContentTypesDestroyedBulk, ContentTypeStored, ContentTypeUpdated, ContentFieldDestroyed, ContentFieldStored, ContentFieldUpdated },
	props: ['loadurl'],
	data() { return {
		activities: [],
		skip: 0,
